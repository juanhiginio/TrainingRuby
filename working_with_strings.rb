...
# Use quotation marks in a string with \" o \' -> Para decirle a Ruby que no cierre la cadena sino que literalmente se
# quiere poner una comilla dentro de la cadena
puts 'Hello "World"'
puts 'Hello \'World\''
...
puts phrase[0, 3] # Obtener una subcadena de la cadena (desde el índice 0 hasta el índice 3) desde el primer indice que
# se le indique hasta el ultimo que se le indique menos 1
puts 'Programming'[0, 3] # Obtener una subcadena de la cadena (desde el índice 0 hasta el índice 3) desde el primer
# indice que se le indique hasta el ultimo que se le indique menos 1
