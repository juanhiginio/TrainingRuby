...
puts types[-2] # prints the element of the array that is at index -2, es decir que es el penúltimo elemento de la lista,
# ya que el -1 es el último elemento de la lista
...
colors = [] # Array without initial values
